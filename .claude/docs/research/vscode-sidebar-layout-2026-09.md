# VS Code Sidebar Layout — Can the Two-Column LayeredKB Mockup Be Built?
...
- **Explorer decorations.** `src/explorerDecorations.ts` uses
  ...
  independent of how LayeredKB renders its own panes and survives either choice.
- **Reveal in explorer.** `layeredkb.revealInExplorer` is a command; a webview can
...
`.claude/docs/plans/multi-drive-contents-2026-09.md` already warns about:
...
`.claude/docs/plans/multi-drive-contents-2026-09.md` §"A declared scope root owns
...
`src/explorerDecorations.ts`, `.claude/docs/DESIGN.md` (view-surface constraint;
15,118-file reference vault), `.claude/docs/plans/multi-drive-contents-2026-09.md`
